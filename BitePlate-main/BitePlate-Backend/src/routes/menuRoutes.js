...
router.get('/combos', menuController.getComboMeals);
router.get('/combos/:id', menuController.getComboMeal);
router.get('/:id', menuController.getMenuItem);

router.post('/', authMiddleware, menuController.createMenuItem);
router.post('/combos', authMiddleware, menuController.createComboMeal);
